            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <form method="POST" action="<?=BASEURL .'/admin/search-report'?>">
                            <div class="row">
                                    ...
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="searchdata" name="searchdata" required="true" placeholder="Enter Reported by Name/ Mobile No / Location">
                                            </div>
