...
<html lang="en">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="/find-result">Students</a></li>
                        <li class="nav-item"><a class="nav-link active" href="/admin-login">Admin</a></li>
                    </ul>
                </div>
            </div>
        </nav>
 ...
 <?php 
// Debugging: Memeriksa apakah 'nid' diterima
if (isset($nid)) {
    echo "Notice ID: " . htmlspecialchars($nid) . "<br>";
} else {
    echo "Notice ID tidak ditemukan.<br>";
    die("Notice ID tidak ditemukan.");
}
